...
Page({
  ...
  onCollectCoupon() {
    wx.request({
      url: 'http://localhost:8080/v1/coupon/collect/4',
      method: 'POST',
      success: res => {
        console.log(res.data)
      },
  ...
  onGetMyCoupons() {
    wx.request({
      url: 'http://localhost:8080/v1/coupon/myself/by/status/1',
      method: 'GET',
      success: res => {
        console.log(res.data)
      },
  ...
  onGetCouponAvailable() {
    wx.request({
  url:'http://localhost:8080/v1/coupon/myself/available/with_category',
      method: 'GET',
      success: res => {
        console.log(res.data)
      },
  ...
  onGetUnpaidOrders() {
    wx.request({
      url: 'http://localhost:8080/v1/order/status/unpaid',
      method: 'GET',
      success: res => {
        console.log(res.data)
      },
  ...
  onGetAllOrders() {
    wx.request({
      url: 'http://localhost:8080/v1/order/by/status/0',
      method: 'GET',
      success: res => {
        console.log(res.data)
      },
  ...
  onGetOrderDetail() {
    wx.request({
      url: 'http://localhost:8080/v1/order/detail/301',
      method: 'GET',
      success: res => {
        console.log(res.data)
      },
