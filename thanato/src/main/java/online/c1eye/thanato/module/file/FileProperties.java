package online.c1eye.thanato.module.file;

import online.c1eye.thanato.common.factory.YamlPropertySourceFactory;
...
@PropertySource(
        value = "classpath:online/c1eye/thanato/extension/file/config.yml",
